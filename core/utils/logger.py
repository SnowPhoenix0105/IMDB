...
total_file = None
file_pool = {} # filename: [file, reference_count]
...
def alloc_logger(log_file_name: str=None, default_head: str or "__name__"=None, default_mid:str='',console_output:bool=True):
    ...
    if log_file_name == None:
        if _default_logger is None:
            log_file_name = config.LOG.DEFAULT_LOG_DIR
            signature = config.LOG.DEFAULT_HEAD
            mid = config.LOG.DEFAULT_MID
            need_console = config.LOG.DEFAULT_NEED_CONSOLE
